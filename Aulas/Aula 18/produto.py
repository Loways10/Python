...
class Produto:
    lista_tipos = ["Alimmentação", "Limmpeza", "Pets"]

    def __init__(self, n, p, qnt, t):
    ...
    def listarProduto(self):
        ...
        print(f'Quantidade Estoque: {self.qntEstoque}')
    ...
    def venderProduto(self, qnt):
        if qnt > self.qntEstoque:
            return print('Quantidade de estoque insuficiente')
        self.qntEstoque -= qnt
        self.listarProduto()
